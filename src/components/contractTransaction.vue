<template>
  <div class="cta_con">
    ...
    <!--<div class="con_title" style="font-size:2rem">-->
    ...
    <div style="position: fixed;top:10%;height:88%;overflow: auto;width: 90%;left: 5%;margin-bottom: 5rem">
      ...
      <div class="cta_all" style="position: relative;top: 2.5rem">
        <div class="cta_all_con">
          <div class="cta_all_con_left">
            {{$t('table.transaction_hash')}}
          </div>
          <div class="cta_all_con_right" style="border-bottom: 1px solid #DCDFE6;padding-bottom: 1rem;margin-bottom: 3rem">
            {{all_data.hash}}
          </div>
        </div>
        <div class="cta_all_con" style="display: flex;justify-content: space-between">
          <div class="cta_all_con_left">
            {{$t('table.state')}}
          </div>
          <div class="cta_all_con_right">
            <span class="el-icon-success state_success_text" v-show="all_data.status==1"></span>
            ...
            <span class="el-icon-error state_error_text" v-show="!all_data.status==1"></span>
        ...
        <!--</div>-->
        <div class="cta_all_con">
          <div class="cta_all_con_left cta_all_con_left_last">
            {{$t('table.input_data')}}
          </div>
